...
declare_id!("FcG4Kf4de4Sx2iiXv6CcFpTBdEpNdYSNsaB4EpLdS7yc");
...
pub mod tokenvesting {
    ...
    pub fn claim_token(ctx: Context<ClaimToken>, _company_name: String) -> Result<()> {
        ...
        let vested_amount = if now >= employee_account.end_time {
            ...
            // employee_account.total_amount
            //     .saturating_mul(time_since_start as u64)
        ...
        //THIS RESULTS IN ERRORS SO I HAVE TO DEFINE THE BUMPS BEFORE PASSING IT TO THE SIGNER SEEDS
        // let signer_seeds: &[&[&[u8]]] = &[
        ...
        let treasury_bump = &[ctx.accounts.vesting_account.treasury_bump];

        let signer_seeds: &[&[&[u8]]] = &[
            &[b"vesting_treasury", company_name_bytes, treasury_bump],
        ];
